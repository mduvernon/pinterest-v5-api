...
export interface Pin {
    ...
    /**
     * The source pin id if this pin was saved from another pin. @see https://help.pinterest.com/article/save-pins-on-pinterestLearn more.
     */
    parent_pin_id?: string | null;
    /**
     * Whether the Pin is standard or not. See documentation on @see https://developers.pinterest.com/docs/content/update/Changes to Pin creation for more information.
     */
    is_standard?: boolean;
    /**
    ...
    /**
     * Private note for this Pin. @see https://help.pinterest.com/en/article/add-notes-to-your-pinsLearn more.
     */
    note?: string | null;
    /**
