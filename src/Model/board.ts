...
export interface Board {
    ...
    owner?: BoardOwner;
    /**
     * Privacy setting for a board. Learn more about @see https://help.pinterest.com/en/article/secret-boardssecret boards and @see https://help.pinterest.com/en/business/article/protected-boardsprotected boards
     */
